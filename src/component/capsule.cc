...
namespace hpp
{
  namespace geometry
  {
	...
	collision::PolyCapsule::setAbsolutePosition (kcdMatrix);
      }
	...
	collision::PolyCapsule::setRelativePosition (kcdMatrix);
      }
      ...
      {
	CkcdMat4 kcdMatrix;
	collision::PolyCapsule::getRelativePosition (kcdMatrix);
	kcdMatrix.toKitMat4 (o_matrix);
      }
