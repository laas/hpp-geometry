...
/**
 * \brief Declaration of DetectorCapsuleSegment.
 */

#ifndef KCD_DETECTOR_CAPSULE_SEGMENT_HH_
# define KCD_DETECTOR_CAPSULE_SEGMENT_HH_
...
namespace hpp
{
  namespace geometry
  {
    namespace collision
    {
      class DetectorCapsuleSegment : public CkcdDetector
      {
      public:
	/// \brief Create a new detector.
	static DetectorCapsuleSegmentShPtr create ();

	/// \brief Create a copy of the detector.
	static DetectorCapsuleSegmentShPtr
	...
	ktStatus init (const DetectorCapsuleSegmentWkPtr& weakPtr);
	...
	DetectorCapsuleSegment (const DetectorCapsuleSegment& detector);
      ...
      private:
	DetectorCapsuleSegmentWkPtr weakPtr_;
      };
...
#endif //! KCD_DETECTOR_CAPSULE_SEGMENT_HH_
